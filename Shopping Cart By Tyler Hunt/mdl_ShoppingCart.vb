Module mdl_ShoppingCart
    ...
    'Test Data
    Public Const gDEC_Book0 As Decimal = 1
    Public Const gDEC_Book1 As Decimal = 2
    Public Const gDEC_Book2 As Decimal = 3
    Public Const gDEC_Book3 As Decimal = 4
    Public Const gDEC_Book4 As Decimal = 5
    Public Const gDEC_Book5 As Decimal = 6
    Public Const gDEC_Book6 As Decimal = 7
    Public Const gDEC_Book7 As Decimal = 8
